...
import '../repeated/user_review.dart';

class TvSeriesDetails extends StatefulWidget {
  final dynamic tvID;

  const TvSeriesDetails({super.key, required this.tvID});
...
class _TvSeriesDetailsState extends State<TvSeriesDetails> {
  ...
  Future<void> tvseriesdetailfunc() async {
    var tvseriesdetailurl =
        'https://api.themoviedb.org/3/tv/${widget.tvID}?api_key=$apiKey';
    var tvseriesreviewurl =
        'https://api.themoviedb.org/3/tv/${widget.tvID}/reviews?api_key=$apiKey';
    var similarseriesurl =
        'https://api.themoviedb.org/3/tv/${widget.tvID}/similar?api_key=$apiKey';
    var recommendseriesurl =
        'https://api.themoviedb.org/3/tv/${widget.tvID}/recommendations?api_key=$apiKey';
    var seriestrailersurl =
        'https://api.themoviedb.org/3/tv/${widget.tvID}/videos?api_key=$apiKey';
                    ...
                    SliverAppBar(
                        ...
                        flexibleSpace: FlexibleSpaceBar(
                          ...
                          background: FittedBox(
                            fit: BoxFit.fill,
                            child: TrailerWatch(
                              trailerID: seriestrailerslist[0]['key'],
                            ),
                          ),
                        )),
                    SliverList(
                      ...
                      Padding(
                        ...
                        child: UserReview(revDetails: TvSeriesREview),
                      ),
                      Container(
                        padding: const EdgeInsets.only(left: 10, top: 20),
                        child: Text(
